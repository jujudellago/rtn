                        ...
                        jQuery("#SC_line_graph").click(function() {
                            ...
                            jQuery.get(url + "/qode_shortcodes_line_graph.php", function(data) {
                                ...
                                jQuery('#TB_window #qode_insert_shortcode_button').click(function() {
                                    ...
                                    var shortcode = "[line_graph " + width + " " + height + " " + scaleSteps + " " + scaleStepWidth + " custom_color='" + custom_color + "' type='" + type + "' labels='Label 1, Label 2, Label 3']#134cfe,Legend One,1,5,10;#5ed0ba,Legend Two,3,7,20;#8cddcd,Legend Three,10,2,34[/line_graph]";
                                    jQuery("#qode_shortcode_form_wrapper").remove()
                                    ed.execCommand('mceInsertContent', false, shortcode);
                                    tb_remove();
                                    return false;
						...
						jQuery("#SC_pie_chart2").click(function(){
							...
							jQuery.get(url + "/qode_shortcodes_pie_chart2.php", function(data){
							   ...
							   jQuery('#TB_window #qode_insert_shortcode_button').click(function(){
									 ...
									 var color = jQuery('#TB_window #color').val();
									 var shortcode = "[pie_chart2 "+width+" "+height+" color='"+color+"']15,#134cfe,Legend One; 35,#5ed0ba,Legend Two; 50,#8cddcd,Legend Three[/pie_chart2]";
								   jQuery("#qode_shortcode_form_wrapper").remove()
								   ed.execCommand('mceInsertContent', false, shortcode);		   										   										   tb_remove();
								   return false;
							   });
						...
						jQuery("#SC_pie_chart3").click(function(){
							...
							jQuery.get(url + "/qode_shortcodes_pie_chart3.php", function(data){
							   ...
							   jQuery('#TB_window #qode_insert_shortcode_button').click(function(){
									 ...
									 var color = jQuery('#TB_window #color').val();
									 var shortcode = "[pie_chart3 "+width+" "+height+" color='"+color+"']15,#134cfe,Legend One; 35,#5ed0ba,Legend Two; 50,#8cddcd,Legend Three[/pie_chart3]";
								   jQuery("#qode_shortcode_form_wrapper").remove()
								   ed.execCommand('mceInsertContent', false, shortcode);		   										   										   tb_remove();
								   return false;
							   });
