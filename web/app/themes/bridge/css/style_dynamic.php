...
<?php } ?>
<?php if (!empty($qode_options_proya['loading_background_color'])) { ?>
	.qode-page-loading-effect-holder{
	background-color: <?php echo $qode_options_proya['loading_background_color']; ?>;
	}
<?php } ?>
...
<?php } ?>
<?php if (!empty($qode_options_proya['page_title_color']) || !empty($qode_options_proya['page_title_fontsize']) || !empty($qode_options_proya['page_title_lineheight']) || !empty($qode_options_proya['page_title_fontstyle']) || !empty($qode_options_proya['page_title_fontweight']) || !empty($qode_options_proya['page_title_texttransform']) || $qode_options_proya['page_title_google_fonts'] != "-1") { ?>
.title h1{
	...
	<?php if (!empty($qode_options_proya['page_title_texttransform'])) { ?>text-transform: <?php echo $qode_options_proya['page_title_texttransform'];  ?>; <?php } ?>
}
<?php } ?>
...
<?php } ?>
<?php if (!empty($qode_options_proya['page_title_medium_fontsize']) || !empty($qode_options_proya['page_title_medium_lineheight']) || !empty($qode_options_proya['page_title_medium_fontweight']) || !empty($qode_options_proya['page_title_medium_texttransform']) || (isset($qode_options_proya['page_title_medium_letterspacing']) && $qode_options_proya['page_title_medium_letterspacing'] !== '')) { ?>
	...
	<?php if (!empty($qode_options_proya['page_title_medium_texttransform'])) { ?>text-transform: <?php echo $qode_options_proya['page_title_medium_texttransform'];  ?>; <?php } ?>
	}
<?php } ?>
<?php if (!empty($qode_options_proya['page_title_large_fontsize']) || !empty($qode_options_proya['page_title_large_lineheight']) || !empty($qode_options_proya['page_title_large_fontweight']) || !empty($qode_options_proya['page_title_large_texttransform']) || (isset($qode_options_proya['page_title_large_letterspacing']) && $qode_options_proya['page_title_large_letterspacing'] !== '')) { ?>
	...
	<?php if (!empty($qode_options_proya['page_title_large_texttransform'])) { ?>text-transform: <?php echo $qode_options_proya['page_title_large_texttransform'];  ?>; <?php } ?>
	}
<?php } ?>
...
if(isset($qode_options_proya['page_subtitle_letter_spacing']) && $qode_options_proya['page_subtitle_letter_spacing'] !== '') {
    $page_subtitle_styles .= 'letter-spacing: '.$qode_options_proya['page_subtitle_letter_spacing'].'px;';
}

if(isset($qode_options_proya['page_subtitle_text_transform']) && $qode_options_proya['page_subtitle_text_transform'] !== '') {
    $page_subtitle_styles .= 'text-transform: '.$qode_options_proya['page_subtitle_text_transform'];
}
...
<?php } ?>
<?php if (!empty($qode_options_proya['small_button_fontsize']) || !empty($qode_options_proya['small_button_lineheight']) || !empty($qode_options_proya['small_button_fontweight']) || !empty($qode_options_proya['small_button_padding']) || (isset($qode_options_proya['small_button_border_radius']) && $qode_options_proya['small_button_border_radius'] !== '')) { ?>
	.qbutton.small{
	...
	<?php if (isset($qode_options_proya['small_button_border_radius']) && $qode_options_proya['small_button_border_radius'] !== '') { ?>	border-radius: <?php echo $qode_options_proya['small_button_border_radius'];  ?>px; <?php } ?>
	<?php if (isset($qode_options_proya['small_button_border_radius']) && $qode_options_proya['small_button_border_radius'] !== '') { ?>	-moz-border-radius: <?php echo $qode_options_proya['small_button_border_radius'];  ?>px; <?php } ?>
	<?php if (isset($qode_options_proya['small_button_border_radius']) && $qode_options_proya['small_button_border_radius'] !== '') { ?>	-webkit-border-radius: <?php echo $qode_options_proya['small_button_border_radius'];  ?>px; <?php } ?>

	}
<?php } ?>
<?php if (!empty($qode_options_proya['large_button_fontsize']) || !empty($qode_options_proya['large_button_lineheight']) || !empty($qode_options_proya['large_button_fontweight']) || !empty($qode_options_proya['large_button_padding']) || (isset($qode_options_proya['large_button_border_radius']) && $qode_options_proya['large_button_border_radius'] !== '')) { ?>
	.qbutton.large{
	...
	<?php if (isset($qode_options_proya['large_button_border_radius']) && $qode_options_proya['large_button_border_radius'] !== '') { ?>	border-radius: <?php echo $qode_options_proya['large_button_border_radius'];  ?>px; <?php } ?>
	<?php if (isset($qode_options_proya['large_button_border_radius']) && $qode_options_proya['large_button_border_radius'] !== '') { ?>	-moz-border-radius: <?php echo $qode_options_proya['large_button_border_radius'];  ?>px; <?php } ?>
	<?php if (isset($qode_options_proya['large_button_border_radius']) && $qode_options_proya['large_button_border_radius'] !== '') { ?>	-webkit-border-radius: <?php echo $qode_options_proya['large_button_border_radius'];  ?>px; <?php } ?>

	}
<?php } ?>
<?php if (!empty($qode_options_proya['big_large_button_fontsize']) || !empty($qode_options_proya['big_large_button_lineheight']) || !empty($qode_options_proya['big_large_button_fontweight']) || !empty($qode_options_proya['big_large_button_padding']) || $qode_options_proya['big_large_button_border_radius'] !== '') { ?>
	.qbutton.big_large,
	...
	<?php if (isset($qode_options_proya['big_large_button_border_radius']) && $qode_options_proya['big_large_button_border_radius'] !== '') { ?>	border-radius: <?php echo $qode_options_proya['big_large_button_border_radius'];  ?>px; <?php } ?>
	<?php if (isset($qode_options_proya['big_large_button_border_radius']) && $qode_options_proya['big_large_button_border_radius'] !== '') { ?>	-moz-border-radius: <?php echo $qode_options_proya['big_large_button_border_radius'];  ?>px; <?php } ?>
	<?php if (isset($qode_options_proya['big_large_button_border_radius']) && $qode_options_proya['big_large_button_border_radius'] !== '') { ?>	-webkit-border-radius: <?php echo $qode_options_proya['big_large_button_border_radius'];  ?>px; <?php } ?>
...
<?php } ?>
<?php if (!empty($qode_options_proya['button_green_border_color']) || !empty($qode_options_proya['button_green_text_color'])  || !empty($qode_options_proya['button_green_background_color'])) { ?>
	.qbutton.green{

	<?php if (!empty($qode_options_proya['button_green_border_color'])) { ?>	border-color: <?php echo $qode_options_proya['button_green_border_color'];  ?>; <?php } ?>
	<?php if (!empty($qode_options_proya['button_green_text_color'])) { ?>	color: <?php echo $qode_options_proya['button_green_text_color'];  ?>; <?php } ?>
	<?php if (!empty($qode_options_proya['button_green_background_color'])) { ?>	background-color: <?php echo $qode_options_proya['button_green_background_color'];  ?>; <?php } ?>
	}
<?php } ?>
<?php if (!empty($qode_options_proya['button_green_border_color_hover']) || !empty($qode_options_proya['button_green_text_color_hover']) || !empty($qode_options_proya['button_green_background_color_hover'])) { ?>
	.qbutton.green:hover {

	<?php if (!empty($qode_options_proya['button_green_border_color_hover'])) { ?>	border-color: <?php echo $qode_options_proya['button_green_border_color_hover'];  ?>; <?php } ?>
	<?php if (!empty($qode_options_proya['button_green_text_color_hover'])) { ?>	color: <?php echo $qode_options_proya['button_green_text_color_hover'];  ?>; <?php } ?>
	<?php if (!empty($qode_options_proya['button_green_background_color_hover'])) { ?>	background-color: <?php echo $qode_options_proya['button_green_background_color_hover'];  ?>; <?php } ?>
	}
<?php } ?>
...
<?php if (!empty($qode_options_proya['counter_text_color']) ||
            ...
            (isset($qode_options_proya['counters_text_lineheight']) && $qode_options_proya['counters_text_lineheight'] !== '')) { ?>
	...
	<?php if ($qode_options_proya['counters_text_letterspacing'] !== '') { ?>	letter-spacing: <?php echo $qode_options_proya['counters_text_letterspacing'];  ?>px; <?php } ?>
        <?php if ($qode_options_proya['counters_text_lineheight'] !== '') { ?>   line-height: <?php echo $qode_options_proya['counters_text_lineheight'];  ?>px; <?php } ?>
...
<?php if ((isset($qode_options_proya['popup_menu_color']) && !empty($qode_options_proya['popup_menu_color'])) ||
          ...
          (isset($qode_options_proya['popup_menu_texttransform']) && !empty($qode_options_proya['popup_menu_texttransform'])) ||
    ...
    <?php if (!empty($qode_options_proya['popup_menu_texttransform'])) { ?> text-transform: <?php echo $qode_options_proya['popup_menu_texttransform'];  ?>; <?php } ?>
...
<?php if ((isset($qode_options_proya['popup_menu_color_2nd']) && !empty($qode_options_proya['popup_menu_color_2nd'])) ||
    ...
    (isset($qode_options_proya['popup_menu_texttransform_2nd']) && !empty($qode_options_proya['popup_menu_texttransform_2nd'])) ||
    ...
    <?php if (!empty($qode_options_proya['popup_menu_texttransform_2nd'])) { ?> text-transform: <?php echo $qode_options_proya['popup_menu_texttransform_2nd'];  ?>; <?php } ?>
...
if(isset($qode_options_proya['cf7_custom_style_1_element_enable_border_bottom']) && $qode_options_proya['cf7_custom_style_1_element_enable_border_bottom'] == 'yes'){
...
$cf7_custom_style_1_button_full_width = qode_options()->getOptionValue('button_cf1_full_width');
...
if(isset($qode_options_proya['cf7_custom_style_2_element_enable_border_bottom']) && $qode_options_proya['cf7_custom_style_2_element_enable_border_bottom'] == 'yes'){
...
if(isset($qode_options_proya['cf7_custom_style_2_element_focus_border_color']) && $qode_options_proya['cf7_custom_style_2_element_focus_border_color'] !== '') {
	if(isset($qode_options_proya['cf7_custom_style_2_border_transparency']) && $qode_options_proya['cf7_custom_style_2_border_transparency'] !== ''){
		...
		$cf7_custom_style_2_elements_focus_styles .= 'border-color: rgba('. $cf7_custom_style_2_element_focus_border_color[0] . ',' . $cf7_custom_style_2_element_focus_border_color[1] . ',' . $cf7_custom_style_2_element_focus_border_color[2] . ',' . $qode_options_proya['cf7_custom_style_2_border_transparency'] .');';
...
$cf7_custom_style_2_button_full_width = qode_options()->getOptionValue('button_cf2_full_width');
...
if(isset($qode_options_proya['cf7_custom_style_3_element_enable_border_bottom']) && $qode_options_proya['cf7_custom_style_3_element_enable_border_bottom'] == 'yes'){
...
if(isset($qode_options_proya['cf7_custom_style_3_element_focus_border_color']) && $qode_options_proya['cf7_custom_style_3_element_focus_border_color'] !== '') {
	if(isset($qode_options_proya['cf7_custom_style_3_border_transparency']) && $qode_options_proya['cf7_custom_style_3_border_transparency'] !== ''){
		...
		$cf7_custom_style_3_elements_focus_styles .= 'border-color: rgba('. $cf7_custom_style_3_element_focus_border_color[0] . ',' . $cf7_custom_style_3_element_focus_border_color[1] . ',' . $cf7_custom_style_3_element_focus_border_color[2] . ',' . $qode_options_proya['cf7_custom_style_3_border_transparency'] .');';
...
$cf7_custom_style_3_button_full_width = qode_options()->getOptionValue('button_cf3_full_width');
...
if(isset($qode_options_proya['qs_v2_button_color']) && $qode_options_proya['qs_v2_button_color']) {
	$qs_v2_button1_styles .= 'color: '.$qode_options_proya['qs_v2_button_color'].' !important;';
}

if(isset($qode_options_proya['qs_v2_button_background_color']) && $qode_options_proya['qs_v2_button_background_color']) {
	$qs_v2_button1_styles .= 'background-color: '.$qode_options_proya['qs_v2_button_background_color'].' !important;';
}

if(isset($qode_options_proya['qs_v2_button_border_color']) && $qode_options_proya['qs_v2_button_border_color']) {
	$qs_v2_button1_styles .= 'border-color: '.$qode_options_proya['qs_v2_button_border_color'].' !important;';
}

if(isset($qode_options_proya['qs_v2_button_hover_color']) && $qode_options_proya['qs_v2_button_hover_color'] != '') {
	$qs_v2_button1_hover_styles .= 'color: '.$qode_options_proya['qs_v2_button_hover_color'].' !important;';
}

if(isset($qode_options_proya['qs_v2_button_hover_background_color']) && $qode_options_proya['qs_v2_button_hover_background_color'] != '') {
	$qs_v2_button1_hover_styles .= 'background-color: '.$qode_options_proya['qs_v2_button_hover_background_color'].' !important;';
}


if($qs_v2_button1_styles != ""){ ?>
	.carousel-inner .slider_content .text .qode-slide-button-1{
	<?php echo $qs_v2_button1_styles; ?>
	}
<?php }
...
if(qode_options()->getOptionValue('qs_v2_button_icon_left_border_color')) {
	$slide_btn_icon_styles['border-color'] = qode_options()->getOptionValue('qs_v2_button_icon_left_border_color');
}
if(qode_options()->getOptionValue('qs_v2_button_icon_background_color')) {
	$slide_btn_icon_styles['background-color'] = qode_options()->getOptionValue('qs_v2_button_icon_background_color');
}

echo qode_dynamic_css($slide_btn_icon_selector, $slide_btn_icon_styles);
...
if(qode_options()->getOptionValue('qs_v2_button_hover_icon_left_border_color')) {
	$slide_btn_hover_icon_styles['border-color'] = qode_options()->getOptionValue('qs_v2_button_hover_icon_left_border_color');
}
if(qode_options()->getOptionValue('qs_v2_button_hover_icon_background_color')) {
	$slide_btn_hover_icon_styles['background-color'] = qode_options()->getOptionValue('qs_v2_button_hover_icon_background_color');
}

echo qode_dynamic_css($slide_btn_hover_icon_selector, $slide_btn_hover_icon_styles);

if($qs_v2_button1_hover_styles != "") { ?>
	.carousel-inner .slider_content .text .qode-slide-button-1:hover{
	<?php echo $qs_v2_button1_hover_styles; ?>
	}
<?php }

if(isset($qode_options_proya['qs_v2_button2_color']) && $qode_options_proya['qs_v2_button2_color']) {
	$qs_v2_button2_styles .= 'color: '.$qode_options_proya['qs_v2_button2_color'].';';
}

if(isset($qode_options_proya['qs_v2_button2_background_color']) && $qode_options_proya['qs_v2_button2_background_color']) {
	$qs_v2_button2_styles .= 'background-color: '.$qode_options_proya['qs_v2_button2_background_color'].';';
}

if(isset($qode_options_proya['qs_v2_button2_border_color']) && $qode_options_proya['qs_v2_button2_border_color']) {
	$qs_v2_button2_styles .= 'border-color: '.$qode_options_proya['qs_v2_button2_border_color'].';';
}

if(isset($qode_options_proya['qs_v2_button2_hover_color']) && $qode_options_proya['qs_v2_button2_hover_color'] != '') {
	$qs_v2_button2_hover_styles .= 'color: '.$qode_options_proya['qs_v2_button2_hover_color'].';';
}

if(isset($qode_options_proya['qs_v2_button2_hover_background_color']) && $qode_options_proya['qs_v2_button2_hover_background_color'] != '') {
	$qs_v2_button2_hover_styles .= 'background-color: '.$qode_options_proya['qs_v2_button2_hover_background_color'].';';
}

if($qs_v2_button2_styles != ""){ ?>
	.carousel-inner .slider_content .text .qode-slide-button-2{
	<?php echo $qs_v2_button2_styles; ?>
	}
<?php }
...
if(qode_options()->getOptionValue('qs_v2_button2_icon_left_border_color')) {
	$slide_btn2_icon_styles['border-color'] = qode_options()->getOptionValue('qs_v2_button2_icon_left_border_color');
}
if(qode_options()->getOptionValue('qs_v2_button2_icon_background_color')) {
	$slide_btn2_icon_styles['background-color'] = qode_options()->getOptionValue('qs_v2_button2_icon_background_color');
}

echo qode_dynamic_css($slide_btn2_icon_selector, $slide_btn2_icon_styles);
...
if(qode_options()->getOptionValue('qs_v2_button2_hover_icon_left_border_color')) {
	$slide_btn2_hover_icon_styles['border-color'] = qode_options()->getOptionValue('qs_v2_button2_hover_icon_left_border_color');
}
if(qode_options()->getOptionValue('qs_v2_button2_hover_icon_background_color')) {
	$slide_btn2_hover_icon_styles['background-color'] = qode_options()->getOptionValue('qs_v2_button2_hover_icon_background_color');
}

echo qode_dynamic_css($slide_btn2_hover_icon_selector, $slide_btn2_hover_icon_styles);

if($qs_v2_button2_hover_styles != "") { ?>
	.carousel-inner .slider_content .text .qode-slide-button-2:hover{
	<?php echo $qs_v2_button2_hover_styles; ?>
	}
<?php } ?>
...
if(isset($qode_options_proya['button_bullet_navigation_active_color']) && !empty($qode_options_proya['button_bullet_navigation_active_color'])) {
    $button_bullet_navigation_active_styles[] = 'background-color: ' . $qode_options_proya['button_bullet_navigation_active_color'];
}

if(isset($qode_options_proya['button_bullet_navigation_active_border_color']) && !empty($qode_options_proya['button_bullet_navigation_active_border_color'])){
    $button_bullet_navigation_active_styles[] = 'border: 1px solid ' . $qode_options_proya['button_bullet_navigation_active_border_color'];
}
...
if(isset($qode_options_proya['button_bullet_navigation_color']) && !empty($qode_options_proya['button_bullet_navigation_color'])) {
    $button_bullet_navigation_styles_a[] = 'background-color: '.$qode_options_proya['button_bullet_navigation_color'];
}
if(isset($qode_options_proya['button_bullet_navigation_size']) && $qode_options_proya['button_bullet_navigation_size'] !== '') {
    $button_bullet_navigation_styles_li[] = 'width: '.$qode_options_proya['button_bullet_navigation_size'].'px';
    $button_bullet_navigation_styles_li[] = 'height: '.$qode_options_proya['button_bullet_navigation_size'].'px';
}
if(isset($qode_options_proya['button_bullet_navigation_border_radius']) && $qode_options_proya['button_bullet_navigation_border_radius'] !== '') {
    $button_bullet_navigation_styles_a[] = 'border-radius: '.$qode_options_proya['button_bullet_navigation_border_radius'].'px';
}

if(isset($qode_options_proya['button_bullet_navigation_border_color']) && !empty($qode_options_proya['button_bullet_navigation_border_color'])){
    $button_bullet_navigation_styles_a[] = 'border: 1px solid ' . $qode_options_proya['button_bullet_navigation_border_color'];
}
