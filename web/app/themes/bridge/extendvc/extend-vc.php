...
vc_add_param("vc_row", array(
	...
	"class" => "",
	"show_settings_on_create"=>true,
	"heading" => "Define the z-index for this row",
	"param_name" => "z_index",
	'save_always' => true,
	'description' => 'The z-index specifies the stack order of an element. Elements with a higher z-index will be displayed above elements with a lower z-index',
...
vc_add_param("vc_single_image",  array(
  ...
  "value" => array(
  		...
  		'Zoom In' => 'zoom_in',
  		'Dark Overlay' => 'darken',
  		esc_html__('Title on bottom') => 'bottom_title'
  	),
  "description" => ""
...
//				),
	...
	array(
            ...
            array(
                ...
                "holder" => "div",
                "class" => "",
                "heading" => esc_html__("Enable Button Background Gradient",'qode'),
                "value" => array(
                	'No' => 'no',
                	'Yes' => 'yes'
                ),
            ...
            array(
                'type'        => 'textfield',
                'heading'     => esc_html__('Font Family','qode'),
            ...
            array(
                'type'        => 'textfield',
                'heading'     => esc_html__('Letter Spacing (px)','qode'),
            ...
            array(
                'type'        => 'dropdown',
                'heading'     => esc_html__('Text Transform','qode'),
...
vc_map( array(
		...
		"params" => array(
			...
			array(
				...
				'heading'     => esc_html__( 'Enable Type Out Effect', 'qode' ),
				'description' => esc_html__( 'Adds a type out effect inside custom font content', 'qode' ),
				'value'       => array_flip( qode_get_yes_no_select_array( false ) )
			),
			array(
				'type'        => 'textfield',
				'param_name'  => 'type_out_position',
				'heading'     => esc_html__( 'Position of Type Out Effect', 'qode' ),
				'description' => esc_html__( 'Enter the position of the word after which you would like to display type out effect (e.g. if you would like the type out effect after the 3rd word, you would enter "3")', 'qode' ),
				'dependency'  => array( 'element' => 'type_out_effect', 'value' => array( 'yes' ) )
			),
			array(
				'type'       => 'colorpicker',
				'param_name' => 'typed_color',
				'heading'    => esc_html__( 'Typed Color', 'qode' ),
				'dependency' => array( 'element' => 'type_out_effect', 'value' => array( 'yes' ) )
			),
			array(
				'type' => 'param_group',
				'heading' => esc_html__( 'Typed Endings', 'qode' ),
				...
				'params' => array(
					array(
						'type' => 'textfield',
						'heading' => esc_html__( 'Typed Ending', 'qode' ),
...
vc_map( array(
	...
	"params" => array(
		...
		array(
			...
			'heading'     => esc_html__( 'Snazzy Map Style', 'qode' ),
			'value'       => array(
				'No'	  => 'no',
				'Yes'	  => 'yes'
			),
			'description' => esc_html__( 'Enabling this option will set predefined snazzy map style', 'qode' )
		),
		array(
			'type'        => 'textarea',
			'param_name'  => 'snazzy_map_code',
			'heading'     => esc_html__( 'Snazzy Map Code', 'qode' ),
			'description' => sprintf( esc_html__( 'Fill code from snazzy map site %s to add predefined style for your google map', 'qode' ), '<a href="https://snazzymaps.com/" target="_blank">https://snazzymaps.com/</a>' ),
...
vc_map( array(
		...
		"params" => array_merge(
            array(
                ...
                array(
                	'type'	=> 'dropdown',
                	'heading'	=> esc_html__('Enable hover effect','qode'),
...
vc_map( array(
		...
		"params" => array(
			...
			array(
				...
				"heading" => "Content",
				"param_name" => "content",
				"value" => "#134cfe,Legend One,1,5,10;#5ed0ba,Legend Two,3,7,20;#8cddcd,Legend Three,10,2,34",
				"save_always" => true,
				"description" => ""
			)
		)
...
vc_map( array(
		...
		"params" => array(
			...
			array(
				...
				"heading" => "Content",
				"param_name" => "content",
				"value" => "15,#134cfe,Legend One; 35,#5ed0ba,Legend Two; 50,#8cddcd,Legend Three",
				"save_always" => true,
				"description" => "",
				'admin_label' => true
			)
...
vc_map( array(
		...
		"params" => array(
			...
			array(
                'type'        => 'dropdown',
                'heading'     => esc_html__('Enable Background Gradient','qode'),
                'param_name'  => 'gradient',
                'value'       => array(
                    'No'      => 'no',
                    'Yes'     => 'yes'
		...
		"params" => array(
			array(
				...
				"value" => array(
					...
					esc_html__('Main Info and Description Below Image','qode') => 'info_description_below_image'
				),
			...
			array(
				"type"	=> "dropdown",
				"heading"	=> esc_html__("Disable image hover zoom animation","qode"),
				"value"	=> array(
					esc_html__("No/Default") => 'no',
					esc_html__("Yes") => 'yes',
				),
...
vc_map( array(
        ...
        "params" => array(
			...
			array(
				...
				"heading" => esc_html__('Enable link','qode'),
...
vc_map( array(
	...
	'params' => array(
		...
		array(
			...
			'value' => array(
				esc_html__('Default','qode')       => 'default',
				esc_html__('Switch Images', 'qode')     => 'switch_img'
			),
			'save_always' => true
		),
		array(
			'type'	=> 'dropdown',
			'heading'	=> esc_html__('Switch Effect', 'qode'),
			'param_name'	=> 'switch_effect',
			'value' => array(
				esc_html__('Fade','qode')       => 'switch_fade',
				esc_html__('Roll Over','qode')     => 'switch_roll'
			),
		...
		array(
			'type'	=> 'dropdown',
			'heading'	=> esc_html__('Disable Cilents Separators', 'qode'),
...
vc_map( array(
	...
	'params' => array(
		...
		array(
			'type'			=> 'attach_image',
			'heading'		=>  esc_html__('Hover Image', 'qode'),
			'param_name'	=> 'hover_image',
			'description'	=> esc_html__("You can use this option only if you have chosen 'Switch Images' as hover effect in Qode Clients", 'qode')
		),
		array(
			'type'			=> 'textfield',
			'heading'		=> 'Link',
...
vc_map( array(
	...
	"params" => array(
			...
			array(
				'type'	=> 'dropdown',
				'heading'	=> esc_html__('Background Size','qode'),
				'param_name'	=> 'cover',
				'value'	=> array(
					esc_html__('Initial/Default','qode')	=> 'no',
					esc_html__('Cover','qode') => 'yes'
				),
				'description'	=> esc_html__('Enable this option if you want background image to cover whole elements holder item','qode'),
				'dependency'	=> array('element' => 'background_image', 'not_empty' => true)
			),
			array(
                "type" => "textfield",
			...
			array(
				"type" => "dropdown",
				"heading" => esc_html__('Horizontal Alignment', 'qode'),
