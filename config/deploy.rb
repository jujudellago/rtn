set :application, 'rtn'
set :repo_url, 'git@github.com:jujudellago/rtn.git'
...
set :linked_files, fetch(:linked_files, []).push('.env', 'web/.htaccess', 'web/app/db.php', 'web/app/object-cache.php', 'web/app/advanced-cache.php', 'web/robots.txt')
...
# are set from that.
set :theme_path, Pathname.new('web/app/themes/rtn')
